...
if not video.isOpened():
    print("Camera at index 0 failed to open. Trying index 1...")
    video = cv2.VideoCapture(1)
    if not video.isOpened():
        print("FATAL ERROR: Cannot open camera at index 0 or 1. Exiting.")
        exit()
...
ageList = ['(0-2)', '(4-6)', '(8-12)', '(13-18)', '(19-24)', '(25-32)', '(38-43)', '(48-53)', '(60-100)']
